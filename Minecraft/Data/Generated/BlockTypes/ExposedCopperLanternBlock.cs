...
public record ExposedCopperLanternBlock(Identifier Identifier, bool Hanging, bool Waterlogged) : IBlock {
    ...
    public Identifier? Item => "minecraft:exposed_copper_lantern";
    ...
    public string TranslationKey => "block.minecraft.exposed_copper_lantern";
    ...
    public IBlock WithState(uint state) {
        return state switch {
            20647 => new ExposedCopperLanternBlock(Identifier, true, true),
            20648 => new ExposedCopperLanternBlock(Identifier, true, false),
            20649 => new ExposedCopperLanternBlock(Identifier, false, true),
            20650 => new ExposedCopperLanternBlock(Identifier, false, false),
