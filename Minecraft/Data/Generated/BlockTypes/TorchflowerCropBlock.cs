...
public record TorchflowerCropBlock(Identifier Identifier, int Age) : IBlock {
    ...
    public Identifier? Item => "minecraft:torchflower_seeds";
    public ICollisionBox BlockShape => ICollisionBox.ParseAabbArrayString("[AABB[0.3125, 0.0, 0.3125] -> [0.6875, 0.375, 0.6875]]");
    ...
    public string TranslationKey => "block.minecraft.torchflower_crop";
