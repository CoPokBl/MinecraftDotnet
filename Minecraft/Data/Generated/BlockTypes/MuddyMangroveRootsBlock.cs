...
public record MuddyMangroveRootsBlock(Identifier Identifier, Axis Axis) : IBlock {
    ...
    public string SoundType => "muddy_mangrove_roots";
    public Identifier? BlockEntity => null;
    public Identifier? Item => "minecraft:muddy_mangrove_roots";
    ...
    public string TranslationKey => "block.minecraft.muddy_mangrove_roots";
