...
public record BirchSaplingBlock(Identifier Identifier, int Stage) : IBlock {

    public Identifier Category => "minecraft:sapling";
    public int ProtocolId => 27;
    ...
    public Identifier? Item => "minecraft:birch_sapling";
    ...
    public string TranslationKey => "block.minecraft.birch_sapling";
    ...
    public IBlock WithState(uint state) {
        return state switch {
            33 => new BirchSaplingBlock(Identifier, 0),
            34 => new BirchSaplingBlock(Identifier, 1),
