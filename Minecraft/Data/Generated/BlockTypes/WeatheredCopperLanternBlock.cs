...
public record WeatheredCopperLanternBlock(Identifier Identifier, bool Hanging, bool Waterlogged) : IBlock {
    public Identifier Category => "minecraft:weathering_lantern";
    ...
    public Identifier? Item => "minecraft:weathered_copper_lantern";
    ...
    public string TranslationKey => "block.minecraft.weathered_copper_lantern";
    ...
    public IBlock WithState(uint state) {
        return state switch {
            20651 => new WeatheredCopperLanternBlock(Identifier, true, true),
            20652 => new WeatheredCopperLanternBlock(Identifier, true, false),
            20653 => new WeatheredCopperLanternBlock(Identifier, false, true),
            20654 => new WeatheredCopperLanternBlock(Identifier, false, false),
