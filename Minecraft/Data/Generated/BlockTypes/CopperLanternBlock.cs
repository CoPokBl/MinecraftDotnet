...
public record CopperLanternBlock(Identifier Identifier, bool Hanging, bool Waterlogged) : IBlock {
    ...
    public Identifier? Item => "minecraft:copper_lantern";
    ...
    public string TranslationKey => "block.minecraft.copper_lantern";
    ...
    public IBlock WithState(uint state) {
        return state switch {
            20643 => new CopperLanternBlock(Identifier, true, true),
            20644 => new CopperLanternBlock(Identifier, true, false),
            20645 => new CopperLanternBlock(Identifier, false, true),
            20646 => new CopperLanternBlock(Identifier, false, false),
