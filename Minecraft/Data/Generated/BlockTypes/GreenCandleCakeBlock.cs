...
public record GreenCandleCakeBlock(Identifier Identifier, bool Lit) : IBlock {
    ...
    public string TranslationKey => "block.minecraft.green_candle_cake";
    ...
    public IBlock WithState(uint state) {
        return state switch {
            22085 => new GreenCandleCakeBlock(Identifier, true),
            22086 => new GreenCandleCakeBlock(Identifier, false),
