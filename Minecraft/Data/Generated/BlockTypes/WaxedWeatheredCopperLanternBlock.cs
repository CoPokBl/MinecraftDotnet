...
public record WaxedWeatheredCopperLanternBlock(Identifier Identifier, bool Hanging, bool Waterlogged) : IBlock {
    ...
    public Identifier? Item => "minecraft:waxed_weathered_copper_lantern";
    ...
    public string TranslationKey => "block.minecraft.waxed_weathered_copper_lantern";
    ...
    public IBlock WithState(uint state) {
        return state switch {
            20667 => new WaxedWeatheredCopperLanternBlock(Identifier, true, true),
            20668 => new WaxedWeatheredCopperLanternBlock(Identifier, true, false),
            20669 => new WaxedWeatheredCopperLanternBlock(Identifier, false, true),
            20670 => new WaxedWeatheredCopperLanternBlock(Identifier, false, false),
