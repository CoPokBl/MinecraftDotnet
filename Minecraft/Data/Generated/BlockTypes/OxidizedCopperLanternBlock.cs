...
public record OxidizedCopperLanternBlock(Identifier Identifier, bool Hanging, bool Waterlogged) : IBlock {
    ...
    public Identifier? Item => "minecraft:oxidized_copper_lantern";
    ...
    public string TranslationKey => "block.minecraft.oxidized_copper_lantern";
    ...
    public IBlock WithState(uint state) {
        return state switch {
            20655 => new OxidizedCopperLanternBlock(Identifier, true, true),
            20656 => new OxidizedCopperLanternBlock(Identifier, true, false),
            20657 => new OxidizedCopperLanternBlock(Identifier, false, true),
            20658 => new OxidizedCopperLanternBlock(Identifier, false, false),
