...
public static partial class PacketRegistry {
    ...
    private static void InitializeClientBoundPlay() {
        ClientBoundPlay = new Dictionary<int, (Type, PacketDataDeserialiser)> {
            ...
            { 0x05, (typeof(ClientBoundSetBlockDestroyStage), ClientBoundSetBlockDestroyStage.Deserialiser) },
            ...
            { 0x1C, (typeof(ClientBoundDisconnectPacketPlay), ClientBoundDisconnectPacketPlay.Deserialiser) },
            ...
            { 0x26, (typeof(ClientBoundKeepAlivePacketPlay), ClientBoundKeepAlivePacketPlay.Deserialiser) },
