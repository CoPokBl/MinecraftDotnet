...
public static partial class PacketRegistry {
    ...
    private static void InitializeClientBoundPlay() {
        ClientBoundPlay = new Dictionary<int, (Type, PacketDataDeserialiser)> {
            ...
            { 0x0A, (typeof(ClientBoundChangeDifficultyPacket), ClientBoundChangeDifficultyPacket.Deserialiser) },
            ...
            { 0x0E, (typeof(ClientBoundClearTitlesPacket), ClientBoundClearTitlesPacket.Deserialiser) },
            { 0x12, (typeof(ClientBoundSetContainerContentPacket), ClientBoundSetContainerContentPacket.Deserialiser) },
            ...
            { 0x39, (typeof(ClientBoundPlayerAbilitiesPacket), ClientBoundPlayerAbilitiesPacket.Deserialiser) },
            ...
            { 0x5A, (typeof(ClientBoundSetDefaultSpawnPositionPacket), ClientBoundSetDefaultSpawnPositionPacket.Deserialiser) },
            { 0x5C, (typeof(ClientBoundSetEntityMetadataPacket), ClientBoundSetEntityMetadataPacket.Deserialiser) },
            { 0x60, (typeof(ClientBoundSetExperiencePacket), ClientBoundSetExperiencePacket.Deserialiser) },
            { 0x61, (typeof(ClientBoundSetHealthPacket), ClientBoundSetHealthPacket.Deserialiser) },
            { 0x62, (typeof(ClientBoundSetHeldItemPacket), ClientBoundSetHeldItemPacket.Deserialiser) },
            { 0x69, (typeof(ClientBoundSetSubtitleTextPacket), ClientBoundSetSubtitleTextPacket.Deserialiser) },
            { 0x6A, (typeof(ClientBoundUpdateTimePacket), ClientBoundUpdateTimePacket.Deserialiser) },
            ...
            { 0x6F, (typeof(ClientBoundStartConfigurationPacket), ClientBoundStartConfigurationPacket.Deserialiser) },
            ...
            { 0x7C, (typeof(ClientBoundUpdateAttributesPacket), ClientBoundUpdateAttributesPacket.Deserialiser) },
