...
public static partial class PacketRegistry {
    ...
    private static void InitializeServerBoundPlay() {
        ServerBoundPlay =  new Dictionary<int, (Type, PacketDataDeserialiser)> {
            ...
            { 0x0C, (typeof(ServerBoundClientInformationPacketPlay), ServerBoundClientInformationPacketPlay.Deserialiser) },
            { 0x14, (typeof(ServerBoundPluginMessagePacketPlay), ServerBoundPluginMessagePacketPlay.Deserialiser) },
            { 0x18, (typeof(ServerBoundInteractPacket), ServerBoundInteractPacket.Deserialiser) },
            { 0x1A, (typeof(ServerBoundKeepAlivePacketPlay), ServerBoundKeepAlivePacketPlay.Deserialiser) },
            ...
            { 0x22, (typeof(ServerBoundPickItemFromBlock), ServerBoundPickItemFromBlock.Deserialiser) },
            { 0x23, (typeof(ServerBoundPickItemFromEntity), ServerBoundPickItemFromEntity.Deserialiser) },
