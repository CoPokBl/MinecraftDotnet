...
public record DisplayMeta(
    ...
    Vec3<double>? Translation = null,
    Vec3<double>? Scale = null,
    ...
    public override EntityMeta LoadFields(EntityMetaContainer container) {
        return (DisplayMeta)base.LoadFields(container) with {
            ...
            Translation = container.GetValue<Vec3<double>>(11),
            Scale = container.GetValue<Vec3<double>>(12),
    ...
    public override EntityMetaContainer CreateContainer() {
        return base.CreateContainer()
            ...
            .WithField(11, MetaFieldType.Position, Translation)
            .WithField(12, MetaFieldType.Position, Scale)
